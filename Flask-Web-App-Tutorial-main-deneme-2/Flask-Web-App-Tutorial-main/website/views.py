...
data=pd.read_csv(r"c:\Users\Mahmut Sevimli\Documents\GitHub\Kalp_krizi_riski_hesaplama\Flask-Web-App-Tutorial-main\Flask-Web-App-Tutorial-main\website\healthcare-dataset-stroke-data4.csv")
